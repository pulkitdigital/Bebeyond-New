export const projects2 = [
  ...
  // Indigenius Matter Project
  {
    ...
    img_title: "Video Production Project Image",
    _h4: "Amplifying Voices Through Video",
    ...
    _pDetails: [
      ...
      {
        _h6: "Client:",
        _pD: "Indigenious Matters",
      },
      {
        _h6: "Category:",
        _pD: "Video Production",
      },
    ],
    _h4_new: "Amplifying Voices Through Video",
    _p_new:
      "Indigenious Matters, an organization dedicated to amplifying Indigenous voices and promoting cultural awareness, approached us with a unique challenge: they needed engaging video content that would resonate with their audience on social media. They wanted to educate, inspire, and spark conversations, all while maintaining a consistent and professional brand identity.",
    _newH5_1: "Challenges:",
    _newp1: [
      "Creating a Consistent Brand Identity: In the crowded world of social media marketing, establishing a strong and recognizable brand is essential. Indigenious Matters needed a visual identity that would be consistent across all their video content. This involved developing a unified style for their videos, including intro animations, text overlays, and graphic elements that would reinforce their brand message and resonate with their target audience.",
      "Producing Engaging Content: Capturing and holding the audience's attention is crucial in today's fast-paced digital world. We needed to create videos that were not only informative but also visually appealing and emotionally resonant. This meant using compelling visuals, dynamic editing, and impactful storytelling to bring Indigenious Matters' message to life.",
      "Optimizing for Social Media: The videos needed to be optimized for different social media platforms, including Instagram Reels, which meant considering different aspect ratios, video lengths, and content formats. We needed to ensure that the videos were easily shareable and looked their best on each platform.",
    ],
    _newH5_2: "Our Approach:",
    _newp2: [
      "Custom Video Template: We started by designing a custom video template that incorporated Indigenious Matters' brand elements and ensured consistency across all their video content. This included an intro animation to establish a professional brand presence, text boxes for clear communication, half-screen boxes to balance visuals and text, and integrated closed captions to enhance accessibility. This template served as a foundation for all their future video content, ensuring a cohesive and recognizable style.",
      "Engaging Visual Storytelling: We used a combination of compelling visuals, dynamic editing, and impactful storytelling to create videos that captured the audience's attention and conveyed Indigenious Matters' messages effectively. We carefully curated visuals, crafted compelling narratives, and used motion graphics to enhance the viewing experience.",
      "Social Media Optimization: We produced videos in various formats and aspect ratios, tailored for different social media platforms. This ensured that the content was easily shareable and reached the widest possible audience. We also optimized the videos for each platform's specific requirements, ensuring they looked their best and performed well.",
      "Adobe Premiere Pro and After Effects: We utilized industry-standard software like Adobe Premiere Pro and After Effects to create high-quality videos with professional-grade motion graphics and visual effects. These tools allowed us to bring our creative vision to life and deliver polished and engaging video content.",
    ],
    _newH5_3: "Solutions:",
    _newp3: [
      "Consistent Branding: The custom video template ensured that all Indigenious Matters' videos had a consistent look and feel, reinforcing their brand identity and making them instantly recognizable across social media.",
      "Engaging Content: The videos we created were visually appealing, informative, and emotionally resonant, leading to increased audience engagement and a stronger connection with their followers.",
      "Streamlined Workflow: The template streamlined Indigenious Matters' content creation process, allowing them to produce high-quality videos more efficiently. This saved them time and resources while ensuring a consistent brand identity across all their video content.",
    ],
    _newH5_4: "Results:",
    _newp4: [
      "Improved Audience Engagement: The videos we produced saw increased views, likes, and shares on social media, indicating higher audience engagement and a growing interest in their message.",
      "Enhanced Brand Identity: The consistent visual style across all videos helped strengthen Indigenious Matters' brand identity and online presence, making them more recognizable and memorable.",
      "Efficient Content Creation: The custom template streamlined their content creation process, saving them time and resources while maintaining a high level of quality and consistency.",
    ],
    _newH5_5: "Key Takeaways:",
    _newp5: [
      "This project highlighted the power of video in communicating a brand's message and engaging audiences on social media.",
      "We learned the importance of creating a consistent visual identity across all video content to strengthen brand recognition and build a loyal following.",
      "By utilizing our expertise in video production, motion graphics, and social media marketing, we helped Indigenious Matters achieve their goals and amplify their message to a wider audience.",
    ],
    _newH5_6: "",
    _newp6: "",
    _newH5_7: "",
  ...
  // Javer Wala Project
  {
    forBrand: "javer_wala",
    _img: "/projects_img/social-media-marketing.jpg",
    img_title: "Social Media Marketing Project Image",
    _h4: "Social Media Success with Meta Ads",
    ...
    _h4_new: "Sparkling Social Media Success with Meta Ads",
    _p_new:
      "Jewar Wallah, a jewellery merchant with a passion for exquisite craftsmanship, wanted to expand their reach and boost sales in the competitive online marketplace. They needed a social media strategy that would not only showcase their stunning jewellery but also drive conversions and generate tangible results. That's where our expertise in social media management and Meta ads came in.",
    _newH5_1: "Challenges:",
    _newp1: [
      "Building Brand Awareness: Jewar Wallah needed to increase their visibility and reach on social media platforms to connect with potential customers.",
      "Driving Traffic to their Online Store: Their primary goal was to drive traffic to their online store and generate sales.",
      "Standing Out from the Competition: The online jewellery market is saturated with competitors. Jewar Wallah needed a strategy that would help them differentiate themselves and capture the attention of their target audience.",
    ],
    _newH5_2: "Our Approach:",
    _newp2: [
      "Social Media Strategy Development: We started by developing a comprehensive social media strategy that aligned with Jewar Wallah's brand identity and business goals. This included identifying their target audience, defining key performance indicators (KPIs), and creating a content calendar that would engage and inspire their followers.",
      "Content Creation and Curation: We created a mix of engaging content, including high-quality images, videos, and stories that showcased Jewar Wallah's exquisite jewellery. We also curated relevant content from other sources to keep their social media feeds fresh and informative.",
      "Community Building: We actively engaged with Jewar Wallah's followers, responding to comments and messages, and fostering a sense of community around their brand.",
      "Meta Ads Campaign Management: We designed and implemented targeted Meta ads campaigns that reached the right audience with compelling visuals and persuasive messaging. We continuously monitored and optimized the campaigns to maximize their effectiveness and ensure a high return on investment (ROI).",
    ],
    _newH5_3: "Solutions:",
    _newp3: [
      "Increased Brand Visibility: Our social media strategy helped Jewar Wallah increase their reach and engagement on social media platforms, building brand awareness and connecting them with potential customers.",
      "Targeted Advertising: Our Meta ads campaigns effectively targeted the ideal customer profile, driving traffic to their online store and generating leads.",
      "Improved Sales Performance: Our combined social media and Meta-ads strategy resulted in a significant increase in sales for Jewar Wallah.",
    ],
    _newH5_4: "Results:",
    _newp4: [
      "Increased website traffic by 30%",
      "Generated 150 qualified leads",
      "Boosted sales by 37.5%",
      "Enhanced Brand Awareness: Jewar Wallah's brand became more recognizable and established in the online jewellery market.",
      "Stronger Customer Relationships: They built stronger relationships with their customers through engaging social media content and interactions.",
    ],
    _newH5_5: "Key Takeaways:",
    _newp5: [
      "This project demonstrated the power of a comprehensive social media and Meta ads strategy in driving business growth.",
      "We leveraged our expertise in social media management, content creation, community building, and meta-ads campaign management to achieve tangible results for Jewar Wallah.",
      "By focusing on data-driven strategies and continuous optimization, we were able to maximize the impact of their social media presence and generate a significant increase in sales.",
    ],
    _newH5_6: "",
    _newp6: "",
    _newH5_7: "",
  ...
  // Kay Pee Dies Project
  {
    ...
    img_title: "Website Redesign Project Image",
  ...
  // Sappy Project
  {
    ...
    img_title: "Branding Project Image",
  ...
  // Zebra Learn Project
  {
    ...
    img_title: "Content Creation Project Image",
  ...
  // Whimsical Tides Project
  {
    ...
    img_title: "Art & Design Project Image",
  ...
  // Data Gol Project
  {
    ...
    img_title: "Design & Marketing Project Image",
  ...
  // Shashwat Singhal & Company Project
  {
    ...
    img_title: "Content & Marketing Project Image",
  ...
  // Venus Project
  {
    ...
    img_title: "Marketing Project Image",

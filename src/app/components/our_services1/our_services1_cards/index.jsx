...
//               viewport={{ once: true }}
//               key={ind}
//               className="card-div-of-our-services-1-cards-container w-32% flex flex-col items-center justify-center bg-white  group relative overflow-hidden 922px:w-48%  400px:min-h-0 400px:w-full 400px:gap-2 rounded-[16px]"
//             >
//               {/* <Image
//                 width={100}
//                 height={100}
...
function OurServices1Cards() {
  ...
  return (
    <div className="our-services-1-cards-container w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 overflow-hidden">
      {cardsData.slice(0, 3).map((data, ind) => {
        return (
          <motion.div
            initial={{ y: "18%", opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            ...
            viewport={{ once: true }}
            key={ind}
            className="card-div-of-our-services-1-cards-container flex flex-col items-center justify-start bg-white group relative overflow-hidden rounded-[16px] pb-4"
          >

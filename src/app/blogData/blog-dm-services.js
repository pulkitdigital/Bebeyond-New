...
export const blogDigitalMarketingServices = {
  ...
  _newp9: [
    <>
      <b className=" font-extrabold">Client-Centric Approach</b>: We prioritize
      clear communication, seamless collaboration, and a personalized approach
      to ensure your marketing goals are met.
    </>,
    <>

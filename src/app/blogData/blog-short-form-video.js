...
export const blogShortFormVideo = {
  ...
  _newp1: [
    <>
      ...
      bite-sized videos, often 60 seconds or less, have exploded in popularity,
      fueled by platforms like TikTok, Instagram Reels, and YouTube Shorts. If
      your brand isn&apos;t leveraging the power of short-form video, you&apos;re
      missing out on a massive opportunity to connect with your audience and
  ...
  _newp2: [
    ...
    <>
      <b className=" font-extrabold">Mobile-First Consumption</b>: We live in a
      mobile-first world, where people consume most of their content on their
      smartphones. Short-form videos are perfectly suited for mobile viewing,
      offering a quick and engaging experience that fits seamlessly into our
      busy lives. They can be consumed on the go, during short breaks, or while
      waiting in line, making them ideal for the modern consumer.
    </>,
    <>
      ...
      captivating format, delivering impactful messages in a matter of seconds.
      They grab attention quickly and keep viewers hooked until the very end.
    </>,
    <>
      ...
      gain traction. This organic reach can significantly boost your brand&apos;s
      visibility without relying solely on paid advertising.
    </>,
    <>
